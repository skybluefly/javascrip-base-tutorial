...
each,map,find,filter,reject,max,min,sortBy,groupBy,first,last,indexOf,lastIndexOf,without,union,pick,omit,has,key,value,chain,contains,pluck,countBy,shuffle,sample,toArray,initial,rest
- 判断类型：  
typeof：   
